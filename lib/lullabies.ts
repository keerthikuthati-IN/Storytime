...
export interface Lullaby {
  ...
  comingSoon?: boolean;
  intro: string;   // spoken by Nana Luna before the song starts
...
export const LULLABIES: Lullaby[] = [
  // ── English ──────────────────────────────────────────────────
  {
    ...
    intro: 'Let Nana Luna sing you a little song about the stars that twinkle just for you...',
    verses: [
  ...
  },
  {
    ...
    emoji: '🌙',
    durationEstimate: '2–3 min',
    intro: 'Settle in, little one. Nana Luna will sing you softly to dreamland...',
    verses: [
  ...
  },
  {
    ...
    emoji: '🌿',
    durationEstimate: '2–3 min',
    intro: 'Sway gently, like a leaf on a sleepy breeze. Nana Luna is here...',
    verses: [
  ...
  },
  {
    ...
    emoji: '🤫',
    durationEstimate: '2–3 min',
    intro: 'Shh... hush now, sweet one. Let Nana Luna sing all your worries away...',
    verses: [
  ...
  },
  {
    ...
    emoji: '☀️',
    durationEstimate: '2–3 min',
    intro: 'You are Nana Luna\'s little sunshine. Let me sing this song just for you...',
    verses: [
  ...
  },
  {
    ...
    intro: 'The little sheep are going to sleep, and so are you. Let Nana Luna sing...',
    verses: [
  ...
  // ── Telugu / లాలి పాటలు ──────────────────────────────────────
  {
    ...
    intro: 'Nana Luna will sing you a beautiful Telugu lullaby. Close your eyes and drift away...',
    verses: [
      'జో జో చిన్నారి\nచందమామ వేళలో\nతారలన్ని చూస్తూ\nనిదురలోకి వెళ్లవో',
      'మెల్లగా గాలి వీసే\nమధురమైన రాత్రిలో\nఅమ్మ మాట వినుతూ\nకలల లోకానికి పో',
    ],
  },
  {
    ...
    emoji: '🌙',
    durationEstimate: '2–3 min',
    intro: 'Laali jo laali... Nana Luna\'s favourite Telugu lullaby, just for you...',
    verses: [
      'లాలి జో లాలి\nబంగారు పాపాయి\nచుక్కలన్నీ చూస్తూ\nనిదుర పోవాలి',
      'వెన్నెల మెల్లగా\nనీ మీద పడగా\nకలల పూలతోటలో\nఆడుకోవాలి',
    ],
  },
  {
    ...
    emoji: '💤',
    durationEstimate: '2–3 min',
    intro: 'Nana Luna will sing you to sleep with this gentle Telugu song...',
    verses: [
      'నిద్ర పో తల్లీ\nకన్నులు మూసుకో\nచందమామ పాటతో\nకలలలో తేలుకో',
      'గాలి మెల్లగా\nజోల పాట పాడగా\nఅమ్మ ఒడిలోనే\nహాయిగా నిదురపో',
    ],
  },
  {
    ...
    durationEstimate: '2–3 min',
    comingSoon: true,
    intro: 'Nana Luna will sing you a special Telugu lullaby about the moon...',
    verses: [
      'జో జో రాముడా\nజాబిలి నవ్వుడా\nతారల మధ్యలో\nతేలుతూ రావుడా',
      'మల్లెల పరిమళం\nరాత్రంతా వీచగా\nచిన్నారి కలల్లో\nచిరునవ్వు పూయగా',
    ],
  },
  {
    ...
    durationEstimate: '2–3 min',
    comingSoon: true,
    intro: 'Listen to Nana Luna sing this peaceful Telugu lullaby...',
    verses: [
      'తాలాలో తల్లీ\nతారల్లో వెల్లీ\nవెన్నెల దారిలో\nకలలకి వెళ్లీ',
      'చుక్కలు పాడగా\nగాలులు ఆడగా\nఅమ్మ ఒడిలోనే\nహాయిగా నిదురపో',
    ],
  },
  {
    ...
    durationEstimate: '2–3 min',
    comingSoon: true,
    intro: 'Fill your eyes with beautiful dreams. Nana Luna will sing you to sleep...',
    verses: [
      'కన్నుల నిండా కలలే\nచందమామ వెలుగులే\nమెల్లగా తేలుతూ\nనిదురలోకి వెళ్లేలే',
      'తారల పాటలు\nగాలుల మాటలు\nచిన్నారి నవ్వుల్లో\nమధురమైన రాత్రులే',
    ],
