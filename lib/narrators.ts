...
export const NANA_LUNA: Narrator = {
  ...
  ttsRate: 0.78,
  ttsPitch: 0.95,
  personality: 'Speaks like a loving Indian grandmother; gentle, unhurried, warm and deeply caring',
  sampleQuote: '"Come, sit close to Nani… let me tell you the most wonderful story… close your little eyes and listen…"',
  emoji: '🧓',
  bgColor: '#FFF8F0',
  accentColor: '#F4A261',
